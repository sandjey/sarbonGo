...
func GetCargoTable(ctx *context.Context) (t table.Table) {
	...
	info.AddField("Capacity required", "capacity_required", db.Decimal)
	info.AddField("Packaging", "packaging", db.Varchar)
	info.AddField("Dimensions", "dimensions", db.Varchar)
...
func GetRoutePointsTable(ctx *context.Context) (t table.Table) {
	...
	info.AddField("Type", "type", db.Varchar).FieldFilterable()
	info.AddField("City code", "city_code", db.Varchar).FieldFilterable()
	info.AddField("Region code", "region_code", db.Varchar)
	info.AddField("Address", "address", db.Varchar)
	info.AddField("Orientir", "orientir", db.Varchar)
	info.AddField("Lat", "lat", db.Decimal)
	info.AddField("Lng", "lng", db.Decimal)
	info.AddField("Place ID", "place_id", db.Varchar)
	info.AddField("Point at", "point_at", db.Timestamp)
	...
	formList.AddField("City code", "city_code", db.Varchar, form.Text)
	formList.AddField("Region code", "region_code", db.Varchar, form.Text)
	formList.AddField("Address", "address", db.Varchar, form.Text)
	formList.AddField("Orientir", "orientir", db.Varchar, form.Text)
	formList.AddField("Lat", "lat", db.Decimal, form.Number)
	formList.AddField("Lng", "lng", db.Decimal, form.Number)
	formList.AddField("Place ID", "place_id", db.Varchar, form.Text)
	formList.AddField("Point at", "point_at", db.Timestamp, form.Datetime)
